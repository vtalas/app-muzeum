...
/***/ function(module, exports, __webpack_require__) {
	...
	var DetailView = _backbone2.default.View.extend({
	    ...
	    render: function render() {
	        ...
	        this.$el.append((0, _jquery2.default)('<h2/>').text(m.get('title')));
	    ...
	    renderTimePlace: function renderTimePlace() {
	        ...
	        if (born) {
	            ...
	            (0, _jquery2.default)('<h3/>', { class: 'born', text: born }).appendTo(cont);
	        }

	        if (died && died !== '???') {

	            // const text = [this.formatDate(new Date(died)), m.get('died_place')];
	            (0, _jquery2.default)('<h3/>', { class: 'died', text: died }).appendTo(cont);
	        }
